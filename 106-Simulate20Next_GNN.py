...
class StrategyPipeline:
    ...
    def _02_pre_all(df_s: pd.DataFrame, ships_list: list) -> pd.DataFrame:
        ...
        all_base = (
            df_s
            .rename(columns={
                "id": "id_src", "step": "step_src",
                "x": "x_src", "y": "y_src", "radius": "radius_src",
                "production": "production_src", "nature": "nature_src", "owner": "owner_src",
            })
            [["id_src", "step_src", "x_src", "y_src", "radius_src",
              "production_src", "nature_src", "owner_src"]]
        )
