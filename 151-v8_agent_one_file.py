...
# ============================================================
# ORBIT WARS - FUSION AGENT  (v8, single-file)
# Base:         Producer V2  (reinforcement risk)
# Upgrades:     Producer Hybrid v4  (4P FFA bonuses + aggression)
# GitHub feat:  5-iteration intercept aiming
# Source:       149-orbit-wars-v8-max-1250-score.ipynb
# ============================================================
...
def cheap_enemy_pressure(obs, cache, *, horizon: float, player_id: int) -> Tensor:
    """Linear-decay estimate of enemy ship mass reachable per planet in `horizon` steps."""
    P = int(obs.P)
    device = obs.device
