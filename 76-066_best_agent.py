...
# ── Scoring weights — autoresearch gen 066 (Mut2-g066) ──
# 8W/1L 2p, 3W 4p, top2=4 → fitness=34 (vice-HoF tier)
PROD_MULT           = 18.7072
TIME_PROD_MULT      =  0.1640
ENEMY_MULT          =  4.1369
COMPOUND_MULT       = 11.2563
MINE_NEAR_TGT_MULT  =  1.5417
ENEMY_NEAR_TGT_MULT =  3.5665
PROD_SRC_MULT       =  9.0708
ORBIT_BONUS         = 32.0000
PROXIMITY_MULT      = 10.4763
DIST_MULT           =  0.4749
SHIPS_MULT          =  0.0972
ETA_MULT            =  0.4827
OVEREXTEND_MULT     =  0.5221
PROXIMITY_DIST      = 48.2624
