"""123-NewGNN_Cosine_finishTraining — Resume 117-NewGNN/model_epoch82.pt, 50 epochs, 16 eps/epoch."""
import math
import random
...
EPISODES_PER_EPOCH = 16  # doubled; pairs sampled per epoch from the pool of 534×4=2136
